...
public class ChocolateBarMouldUpdateTickProcedure {
		...
		if (new Object() {
			...
			if (world.getLevelData().getGameRules().getBoolean(AssortedcuisineModGameRules.BUTTER_DEBUG_TICK_MESSAGE) == true) {
				if (!world.isClientSide() && world.getServer() != null)
					world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A77\u00A7oChocolate Bar Mould Tick"), false);
