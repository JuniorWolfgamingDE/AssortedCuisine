 ...
 *
 */
package net.juniorwmg.assortedcuisine;
...
@Mod("assortedcuisine")
public class AssortedcuisineMod {
	public static final Logger LOGGER = LogManager.getLogger(AssortedcuisineMod.class);
	public static final String MODID = "assortedcuisine";

	public AssortedcuisineMod() {
